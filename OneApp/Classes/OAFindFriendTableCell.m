...
@interface OAFindFriendTableCell ()
...
@property (nonatomic, strong) OAProfileImageView *avatarImageView;

@end


@implementation OAFindFriendTableCell
@synthesize delegate;
@synthesize user;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
	{
        ...
        self.avatarImageView = [[OAProfileImageView alloc] init];
...
- (void)setUser:(PFUser *)aUser
{
    ...
    // Configure the cell
    [avatarImageView setFile:[self.user objectForKey:kOAUserProfilePicSmallKey]];
    
    // Set name
    NSString *nameString = [self.user objectForKey:kOAUserDisplayNameKey];
    ...
    [nameButton setTitle:[self.user objectForKey:kOAUserDisplayNameKey] forState:UIControlStateNormal];
    [nameButton setTitle:[self.user objectForKey:kOAUserDisplayNameKey] forState:UIControlStateHighlighted];
